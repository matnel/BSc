...
Näiden kriteerien pohjalta \citet{Tobias2004} päätyvät suosittelemaan RePast-ympäristöä. RePast sallii useamman kielen käytön simulaation kehityksessä, mikä on mahdollistanut sopivan ekosysteemin käytön kehityksessä \cite{North2006}.

\subsection{Sovellukset yhteiskuntatieteissä}

Esimerkkeinä yhteiskuntatieteen sovelluksista mainittakoon \citet{VonRandow2011}
